...
import eu.kanade.tachiyomi.ui.video.browse.extension.VideoExtensionDetailsScreenModel
...
@Composable
fun VideoExtensionDetailsScreen(
    navigateUp: () -> Unit,
    state: VideoExtensionDetailsScreenModel.State,
...
private fun VideoExtensionDetails(
    contentPadding: PaddingValues,
    extension: Extension.InstalledVideo,
    sources: ImmutableList<VideoExtensionSourceItem>,
