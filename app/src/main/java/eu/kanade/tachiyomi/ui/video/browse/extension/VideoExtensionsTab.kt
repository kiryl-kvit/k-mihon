...
@Composable
fun videoExtensionsTab(
    screenModel: VideoExtensionsScreenModel,
): TabContent {
    ...
    return TabContent(
        ...
        content = { contentPadding, _ ->
                    ...
                    state.isEmpty -> {
                        ...
                        ScrollbarLazyColumn(contentPadding = contentPadding) {
                            state.items.forEach { entry ->
                                ...
                                item(key = "video-ext-header-${header.hashCode()}") {
                                    Text(
                                        text = when (header) {
                                ...
                                items(
                                    ...
                                    key = { index ->
                                        ...
                                        "video-ext-${extension.pkgName}-${extension.versionCode}"
                                    },
                                ) { index ->
                                    ...
                                    Row(
                                        modifier = Modifier
                                            .combinedClickable(
                                                onClick = {
                                                    when (extension) {
                                                        is Extension.InstalledVideo -> navigator.push(VideoExtensionDetailsScreen(extension.pkgName))
                                                        is Extension.AvailableVideo -> screenModel.installExtension(extension)
                                        ...
                                        when {
                                            ...
                                            extension is Extension.AvailableVideo -> {
                                            ...
                                            extension is Extension.InstalledVideo && extension.hasUpdate -> {
            ...
            privateExtensionToUninstall?.let { extension ->
                VideoExtensionUninstallConfirmation(
...
@Composable
private fun VideoExtensionUninstallConfirmation(
