...
- Keep the current `SourceManager` manga-only and add a parallel `AnimeSourceManager`.
...
- `AnimeCatalogueSource` or equivalent browse/search contract for anime titles
- `VideoSource` or equivalent playback contract for episodes and streams
- `SAnime` for source-level anime title rows
...
- the current proposed contract includes `AnimeSource`, `AnimeCatalogueSource`, `AnimeSourceFactory`, `ConfigurableAnimeSource`, `SAnime`, `SEpisode`, `AnimesPage`, `VideoStream`, and `VideoRequest`
...
- [x] Define the full parallel anime model set (`SAnime`, `SEpisode`, app/domain/data models)
...
Note: initial source-api scaffolding from Phase 0 covered the early interface work. Phase 2 is now complete and established the runtime plumbing: typed extension models, loader branching, `AnimeSourceManager`, backend-only anime extension registration, and separate anime source preference wiring.
...
- [x] Add `AnimeSourceManager` and typed source registration
...
Detailed plan: `docs/ANIME-PHASE-4-PLAYER.md`
...
Detailed plan: `docs/ANIME-PHASE-5-UI.md`
...
- Phase 5 implementation is functionally complete; detailed status now lives in `docs/ANIME-PHASE-5-UI.md`.
...
Detailed plan: `docs/ANIME-PHASE-6-HISTORY-UPDATES-SETTINGS.md`
...
Detailed plan: `docs/ANIME-PHASE-7-HARDENING-AND-POLISH.md`
...
Detailed plan: `docs/ANIME-PHASE-8-PRIVATE-EXTENSIONS-AND-REZKA.md`
...
- expose all four Rezka sections from the start via `AnimeSourceFactory`
...
- add a parallel `AnimeSourceManager`
...
Next planned slice: `Phase 8`, which starts the private extensions track with a separate repo and the first real source, `rezka.ag`. See `docs/ANIME-PHASE-8-PRIVATE-EXTENSIONS-AND-REZKA.md`.
...
- `docs/ANIME-PHASE-0-ARCHITECTURE.md`
- `docs/ANIME-PHASE-1-PROFILES.md`
- `docs/ANIME-PHASE-2-SOURCE-API.md`
- `docs/ANIME-PHASE-3-DATA.md`
- `docs/ANIME-PHASE-4-PLAYER.md`
- `docs/ANIME-PHASE-5-UI.md`
- `docs/ANIME-PHASE-8-PRIVATE-EXTENSIONS-AND-REZKA.md`
...
- expose the four Rezka sections through `AnimeSourceFactory`
