# Anime Phase 5: Anime Profile Shell and Core UI
...
- map source-side `SAnime` into local `AnimeTitle`
...
- popular/latest/search listing calls the correct `AnimeCatalogueSource` methods
...
Detailed Phase 6 plan: `docs/ANIME-PHASE-6-HISTORY-UPDATES-SETTINGS.md`
